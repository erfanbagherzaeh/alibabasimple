...
import SliderPB from '../../components/sliderPB/SliderPB'
...
function ParvazB(){
    return(
        ...
        <div className=" w-full  mb-5 sm:h-56 sm:w-4/5 sm:m-auto">
            <img className="z-0 rounded-3xl w-full " src="https://cdn.alibaba.ir/h2/desktop/assets/images/hero/hero-b5a880ed.webp"/>
        </div>
        <Course></Course>
        <Feature></Feature>
