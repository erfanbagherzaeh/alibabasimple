...
function Navbar(){
    return(
        ...
        <div className='z-10 nav-border w-full h-16  flex '>
            <div className='nav-left w-0 h-0 md:w-1/2 md:h-10  flex flex-row justify-end' >
                <div className=' mt-2.5 md:w-[75%] md:h-full b md:flex md:flex-row md:justify-between md:items-center'>
            ...
            <div className='nav-right w-full h-full flex flex-row justify-around items-center md:w-1/2'>
